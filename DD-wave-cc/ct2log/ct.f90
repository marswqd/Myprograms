...
!作者: 王清东  时间: 2013/4/2 9:11:44
program ct
 implicit none
 
 integer*4::i,j,k,nerr,num,nsta,npos,neve,ID
...
!读取控制文件信息 
 ...
 do i=1,neve
  ...
  AZ=rhdr(52)
  if(A/=-12345.0e0) then
   write(13,'(a3,2x,f7.2,2x,f3.1,2x,a1,2x,f8.3,2x,f6.2)') tempc1,A,Pweight,'P',DIST,AZ
  endif
  if(T0/=-12345.0e0) then
   write(13,'(a3,2x,f7.2,2x,f3.1,2x,a1,2x,f8.3,2x,f6.2)') tempc1,T0,Sweight,'S',DIST,AZ
  endif
