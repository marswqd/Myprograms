...
# data file is hypoDD's output file hypoDD.reloc
#!/bin/sh

#Set parameters for plot
psfile=proreloc.ps
locfile=hypoDD.reloc
...
evla1=`awk '{if($1==7) print $2}' ${locfile}`
evlo1=`awk '{if($1==7) print $3}' ${locfile}`
dep1=`awk '{if($1==7) print $4}' ${locfile}`
evla2=`awk '{if($1==21) print $2}' ${locfile}`
evlo2=`awk '{if($1==21) print $3}' ${locfile}`
dep2=`awk '{if($1==21) print $4}' ${locfile}`
psmeca -J -R -Sc1 -C0.5pP2p -W1p -K -O << ! >> ${psfile}
${evlo1} ${evla1} ${dep1} 350 51  35 236 63 136 2.858 24 103.90 27.49 201209071119  
${evlo2} ${evla2} ${dep2} 234 58 155 338 69  34 1.103 24 103.90 27.44 201209071216  
!
# psmeca -J -R -Sc1 -C0.5pP2p -W1p -K -O << ! >> ${psfile}
