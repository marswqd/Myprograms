...
!-----
 ...
 real*4,parameter::vlow=1.0e0,vhigh=6.0e0      !速度窗(信号窗)
...
!读取波形信息并进行窄带滤波
  ...
  do j=1,ntc
   ...
   dyn=(temp1(ph-vl+2)-temp1(ph-vl+1))/(tt1(ph-vl+2)-tt1(ph-vl+1))
   !print*, dy1,dyn
...
! hf:频率窗半宽度
 ...
 PDI(nfft/2+2:nfft)=0.0e0       !令负频率为零
