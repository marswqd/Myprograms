...
######
cat > dfile << EOF
50.0 0.025 1024 -1.0 10.0
55.0 0.025 1024 -1.0 10.0
...
# Chapter 3
#####
hprep96 -M model.d -HS ${HS} -HR 0 -d dfile -ALL #-ALP 3.0 #-ML 3.0 #-NDEC 10 -XF 0.5 -NDEC 2
hspec96 > hspec96.out
hpulse96 -D -p -l 4 > file96

#fbutt96 -fl 2.0 -fh 10.0 -n 4 < file96 > butt96
