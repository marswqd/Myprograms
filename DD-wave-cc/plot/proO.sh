...
# data file is ph2dt's output file event.dat or event.dat
#!/bin/sh
...
#pscoast -J${J} -R -Df -A10 -G200 -Ia -Na -V -K -O >> ${psfile}
#Draw km scale
pscoast -J -R -W1.0p,black -Lf104/27.37/27/30 -K -O >> ${psfile}
#Make cpt file
makecpt -Cwysiwyg -T0/20/0.1 -I -Z > g.cpt
#Draw epicenter map
awk '{if($6<5.1) print $4,$3,$5,$6*0.065}' ${locfile} | psxy -J -R -Cg.cpt -Sc -K -O >> ${psfile}
#draw main earthquake
awk '{if($10==7) print $4,$3,$5,$6*0.065}' ${locfile} | psxy -J -R -Cg.cpt -W0.5p,black -Sa -K -O >> ${psfile}
awk '{if($10==21) print $4,$3,$5,$6*0.065}' ${locfile} | psxy -J -R -Cg.cpt -W0.5p,black -Ss -K -O >> ${psfile}
...
psxy -J -R -Sc -Gblue -N -K -O << ! >> ${psfile}
103.84 27.73 0.065
103.86 27.73 0.13
103.88 27.73 0.195
103.90 27.73 0.26
...
#Get project data
awk '{print $4,$3,$5,$6,$10}' ${locfile} | project -C${c} -A${az}  -Q -V > proA.tmp
awk '{print $4,$3,$5,$6,$10}' ${locfile} | project -C${c} -A${baz} -Q -V > proB.tmp
