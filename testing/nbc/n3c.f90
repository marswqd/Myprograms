...
!读取控制文件信息
 ...
 read(9,*) num,ntc                             !num:处理的实际文件数为num*3
 wname='n3c.txt'
 open(IRU,file='n3c.txt')
 do i=1,num
  read(9,*) name12
  read(9,*) name23
  read(9,*) name13
 ...
 dd=d12+d23-d13
  ...
  write(IRU,110)
  110 format('Period'6x'TT12'5x'TT23'5x'TT13'6x'dTT'2x'PHI/(-pi/4)'1x'cc12'5x'cc23'5x'cc13'5x'dc12'5x'dc23'5x'dc13')
  120 read(IRU+1,*,end=130) tc(1),tt12
   ...
   write(IRU,'(f6.2,2x,5f9.3,6f9.4)') t,tt12,tt23,tt13,dtt,-phi/pi*4,cc12,cc23,cc13,cc12-c12,cc23-c23,cc13-c13
  goto 120
  130 continue
  close(IRU+1)
  close(IRU+2)
